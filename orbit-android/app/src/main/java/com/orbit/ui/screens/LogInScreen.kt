...
fun SignInScreen(
    ...
    when {
        !isInitialized -> {
            OrbitLoadingUI(subtitle = "Setting things up for you...")
        }
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                colors = OutlinedTextFieldDefaults.colors(
                    focusedBorderColor = Color.Red, cursorColor = Color.Red
                ),
                singleLine = true,
            )
                ...
                Card(
                    ...
                    Column(
                        ...
                        CircularProgressIndicator(
                            color = Color.Red, modifier = Modifier.size(48.dp), strokeWidth = 4.dp
                        )
